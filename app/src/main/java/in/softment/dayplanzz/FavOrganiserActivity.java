...
public class FavOrganiserActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fav_organiser);
        ...
        TextView no_fav_organiser = findViewById(R.id.no_fav_organiser);
        ...
        Services.getAllFavOrganiser(new AllFavOrganiserListener() {
            @Override
